...
exports.setTokenCookie = exports.createNewJWT = exports.getAccessTokenHeaders = exports.testTOKEN = exports.decodeUserId = exports.isExpiredRereshToken = exports.verifyToken = exports.genRefreshToken = exports.genPriPubKey = exports.genAccessToken = void 0;
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
const crypto_1 = __importDefault(require("crypto"));
const utils_1 = require("../helper/utils");
const models_1 = require("../user/models");
const genAccessToken = (payload, privateKey, expiresIn) => jsonwebtoken_1.default.sign(payload, privateKey, { algorithm: "RS256", expiresIn });
...
const verifyToken = (accessToken, publicKey) => {
    try {
        ...
        console.error("\nError at verifyToken function in methods.ts:\n", error.message);
        return false;
    }
};
...
const createNewJWT = async (userId) => {
    ...
    const resultUpdateToken = await (0, models_1.updateToken)(userId, publicKey, refreshToken);
    return resultUpdateToken ? { accessToken, refreshToken } : resultUpdateToken;
};
